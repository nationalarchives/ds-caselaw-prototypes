...
"use strict";
/*!***************************************************!*\
  !*** ./ds_caselaw_editor_ui/static/js/src/app.js ***!
  \***************************************************/
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(".judgment-toolbar__delete").click(function () {
  return confirm("Are you sure you want to delete this judgment? Deletion is permanent.");
});
jquery__WEBPACK_IMPORTED_MODULE_0___default()(".judgments-list__judgment-assign-form").on("submit", function (event) {
  event.preventDefault();
  var form = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this);
  var uri = form.find("input[name='judgment_uri']").val();
  var action = form.attr("action");
  var loading = jquery__WEBPACK_IMPORTED_MODULE_0___default()("<span class='loading-indicator' role='progressbar' aria-valuetext='Loading' aria-busy='true' aria-live='polite'></span>");
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default().ajax({
    ...
    success: function success(data) {
      ...
      loading.replaceWith("<a aria-busy='false' href='/edit?judgment_uri=" + encodeURIComponent(uri) + "#assigned_to'>" + assigned_to + "</a>");
    }
  });
});
})();
